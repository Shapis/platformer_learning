...
public class ChestScript : MonoBehaviour
{
    ...
    [SerializeField]
    private GameObject m_BrownCoinPrefab;

    [SerializeField]
    private GameObject m_PurpleCoinPrefab;

    [SerializeField]
    private GameObject m_CoinsContainer;

    [SerializeField]
    private float m_BrownCoinIntangibilityTime = 0f;

    [SerializeField]
    private float m_PurpleCoinIntangibilityTime = 3f;

    [SerializeField]
    private int m_BrownCoinDrops = 3;
